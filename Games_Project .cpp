...
public:
    ...
    // circular end 
    /////////////////////////////// main game begin /////////////////////////////// 
    // usage double linked list with stack
    struct node
    {
        int data;
        node* down;
    ...
    node* del = NULL;
    // fun insert value at each coloums
    ...
    // change between coloum 1 and coloum 2
    void add_coloum1_2()
    {
    ...
    // change between coloum 4 and coloum 3
    void add_coloum4_3()
    {
    ...
    // change between coloum 2 and coloum 1 and coloum 3
    ...
    // change between coloum 3 and coloum 2 and coloum 4
    ...
    // usage for make every change that maybe happend in coloums
    ...
    // to show which coloum is empty or full for ( end or continue the game ) 
